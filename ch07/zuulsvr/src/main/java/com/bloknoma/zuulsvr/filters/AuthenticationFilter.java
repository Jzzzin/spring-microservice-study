...
import com.bloknoma.zuulsvr.model.UserInfo;
...
public class AuthenticationFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        // If we are dealing with a call to the authentication service,
        // let the call go through without authenticating
        ...
        if (userInfo != null) {
            ...
            logger.debug("The user id from the token is : " + userInfo.getUserId());
            logger.debug("The organization id from the token is : " + userInfo.getOrganizationId());
            return null;
        }
    ...
    private UserInfo isAuthTokenValid() {
        ...
        try {
            restExchange = restTemplate.exchange(
                    ...
                    HttpMethod.GET, null, UserInfo.class, filterUtils.getAuthToken());
